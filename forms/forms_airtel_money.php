...
function form_include_airtel()
{
	...
	$content .= '<div class="service"><img src=" '.plugin_dir_url(__FILE__).'airtel.png" alt=""></div>';
	...
	$content .= '</label>';
	$content .= '<label>';
	$content .= '<span> </span><input type="submit" name="form_airtel_money" value="SEND REQUEST" />';
	$content .= '</label>';
	$content .= '</form>';
